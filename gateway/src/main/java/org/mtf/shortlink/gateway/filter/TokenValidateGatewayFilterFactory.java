...
package org.mtf.shortlink.gateway.filter;

import com.alibaba.fastjson2.JSON;
import com.alibaba.fastjson2.JSONObject;
import org.mtf.shortlink.gateway.config.Config;
import org.mtf.shortlink.gateway.dto.GatewayErrorResult;
        ...
        return (exchange, chain) -> {
            ...
            if (!isPathInWhiteList(requestPath, requestMethod, config.getWhitePathList())) {
                ...
                return response.writeWith(Mono.fromSupplier(() -> {
                    ...
                    GatewayErrorResult resultMessage =new GatewayErrorResult();
                    resultMessage.setStatus(HttpStatus.UNAUTHORIZED.value());
                    resultMessage.setMessage("Token validation error");
